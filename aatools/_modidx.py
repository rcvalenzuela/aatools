...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'aatools.core': { 'aatools.core.plot_univariate_continuous': ('core.html#plot_univariate_continuous', 'aatools/core.py'),
            ...
            'aatools.datasets': { 'aatools.datasets.load_predictions': ('datasets.html#load_predictions', 'aatools/datasets.py'),
                                  'aatools.datasets.load_transport': ('datasets.html#load_transport', 'aatools/datasets.py')},
